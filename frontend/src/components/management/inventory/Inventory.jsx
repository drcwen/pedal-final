...
import SetMaintenanceStatus from "./Bikes/SetMaintenanceStatus"
...
function Inventory() {
    ...
    const [fetchBikeId, setFetchBikeId] = useState(null);
    ...
    const handleBikeStatusUpdate = async () => {
        ...
        if (fetchBikeStatus === "Under Maintenance") {
            setBikeEdit(false);
                            ...
                            <div className='fixed inset-0 bg-black/60 z-50 flex items-center justify-center px-5'>
                                <div className='bg-[#ffffff] w-100 rounded-xl flex flex-col gap-5 p-5 font-akagi font-bold text-gray'>
                                    ...
                                    <div  className='pt-5 flex flex-row justify-between font-akagi font-bold text-gray'>
                                        ...
                                        <div
                                            onClick={
                                                fetchBikeStatus === "Rented"
                                                    ? undefined
                                                    : handleBikeStatusUpdate
                                            }
                                            className={`rounded-lg text-[#ffffff] px-2 py-0.5 ${
                                                fetchBikeStatus === "Rented"
                                                    ? "opacity-50 bg-gray cursor-not-allowed"
