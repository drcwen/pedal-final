                ...
                <div className='w-full h-full p-10 bg-[#ffffff] rounded-xl flex flex-col gap-5 overflow-y-scroll scrollbar-thin scrollbar-thumb-[#B9B9B9] scrollbar-track-[#E2E2E2]'>
                        ...
                        >
                            <div className='w-full p-5 md:border-r-1 md:border-gray/60 flex flex-col gap-5'>
                                ...
                                <div className="w-full md:flex md:flex-col md:justify-center md:items-center">
                                    <div className="w-full md:grid md:grid-cols-[150px_1fr] flex flex-col font-akagi font-medium text-gray gap-2 md:items-center">
                                        ...
                                        <div className="flex justify-between">
                                            <input
                                                ...
                                                max="22:00"
                                                step="1800"
                                                className="border border-gray rounded-lg px-3 py-1 focus:outline-none"
                                            />
                    ...
                    {activeTab === "revenueDeductions" &&
                        <motion.div
                            ...
                            exit={{ height: 0, opacity: 0 }}
                            transition={{ duration: 0.3, ease: "easeInOut" }}
                            className="w-full flex-1 min-h-0 grid grid-cols-2 rounded-xl bg-[#ebebeb] border border-gray/60"
                        >
