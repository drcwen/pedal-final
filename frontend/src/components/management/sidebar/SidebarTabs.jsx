...
function SidebarTabs({icon: Icon, name, isActive}) {
    

  return (
    <>

        <div className={`group rounded-lg px-8 py-2 flex flex-row gap-3 items-center cursor-pointer hover:bg-yellow duration-300 transition-all ${isActive ? "bg-yellow" : "bg-transparent hover:bg-yellow"}`}>
